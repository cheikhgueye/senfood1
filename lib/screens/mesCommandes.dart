...
class _RepasListState extends State<CommandeS >
    ...
    return
      ...
      new FirebaseAnimatedList(
        ...
        itemBuilder: (BuildContext context, DataSnapshot snapshot,
          ...
          return
            Commande.fromSnapshot(snapshot).userid!=uid?  SizedBox():
                InkWell(
                    onTap: (){

                      Navigator.push(context, MaterialPageRoute(
                          builder: (_) =>Detail(idresto: Commande.fromSnapshot(snapshot).uid ,)
                      ));
                    },
          child:
            new SizeTransition(
